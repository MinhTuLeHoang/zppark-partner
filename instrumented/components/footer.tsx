        ...
        <footer className={footerStyle.container}>
            ...
            <div className={footerStyle.subdetail}>
                <div className={footerStyle.block}>
                    <h2 className={footerStyle.title}>Some Pages</h2>
                ...
                <div className={footerStyle.block}>
                    <h2 className={footerStyle.title}>Help Center</h2>
                    <div className={footerStyle.link}>
                ...
                <div className={footerStyle.block}>
                    <h2 className={footerStyle.title}>Social Media</h2>
            ...
            <div className={footerStyle.bottomdetail}>
                ...
                <div>
                    <a href="#" className={footerStyle.text}>Policies </a>
                    <span className={footerStyle.text}>and</span>
                    <a href="#" className={footerStyle.text}> Privacies</a>
                </div>
            </div>
